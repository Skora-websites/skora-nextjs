...
const toneClasses: Record<PillTone, string> = {
  blue: "glass-pill",
  emerald: "bg-emerald-500/10 border border-emerald-400/30 text-emerald-400 backdrop-blur-sm",
  gold: "bg-amber-500/10 border border-amber-400/30 text-amber-400 backdrop-blur-sm",
};
