            ...
            <div className="p-8 rounded-[2.5rem] bg-white border border-[#E1E6DF] shadow-xl space-y-8">
              ...
              <div className="space-y-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <a href={`mailto:${siteContent.email}`} className="block text-base font-bold text-[#0B1310] hover:text-[#2563EB] transition-colors mt-0.5">{siteContent.email}</a>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-base font-bold text-[#0B1310] mt-0.5">{siteContent.address}</p>
                  </div>
                </div>
              </div>
              ...
              <div className="pt-6 border-t border-[#E1E6DF] space-y-4">
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-xs font-bold text-slate-700">{siteContent.responseGuarantee}</span>
                </div>
                <div className="flex items-center gap-3">
