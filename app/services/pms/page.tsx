...
import { Layers, ArrowRight, Check, CalendarClock } from "lucide-react";
  ...
  return (
    <main ref={containerRef} className="min-h-screen bg-[#F4F6F1] text-[#0B1310] font-sans relative overflow-x-hidden">
      ...
      <section className="pt-36 pb-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        ...
        >
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded text-xs font-semibold uppercase tracking-wider border border-[#E1E6DF] bg-white text-slate-800 shadow-sm">
            ...
            <span>PROJECT MANAGEMENT SYSTEMS</span>
          </div>

          <h1 className="text-4xl sm:text-6xl lg:text-7xl font-extrabold text-[#0B1310] tracking-tight leading-[1.02] uppercase">
            AGILE WORKFLOWS &amp; <br />
            <span className="text-[#22C55E]">CLIENT APPROVAL PORTALS</span>
          </h1>

          <p className="text-lg text-slate-600 font-normal leading-relaxed">
            Custom PMS platforms with interactive Gantt charts, real-time task tracking, client review portals, and automated team notifications.
          </p>
        ...
        >
          <img
            ...
            alt="PMS Software Architecture"
            onError={(e) => {
              (e.target as HTMLImageElement).src = "https://images.unsplash.com/photo-1507925921958-8a62f3d1a50d?auto=format&fit=crop&w=1200&q=80";
            }}
        ...
        <div className="mt-20 relative rounded-xl overflow-hidden bg-white p-10 sm:p-16 text-center text-[#0B1310] border border-[#E1E6DF] shadow-lg">
          <div className="max-w-2xl mx-auto space-y-6">
            ...
            <p className="text-slate-600 text-sm font-normal">
              Let's discuss how customized project management software can streamline client deliverables.
            </p>
      ...
      <ContactModal
        ...
        defaultService="Project Management Systems"
      />
    </main>
  );
}
